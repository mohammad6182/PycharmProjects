...
class UniversityClasses(models.Model):
    ...
    #DIsplay thr object output values in the front of a string

    def __str__(self):
                 # Returns the input value of the title and the instructure name
            # field as a tuple to display in the browser instead of the default titles
        display_course = '{0.title}: {0.instructor_name}'
        return display_course.format(self)

    # removes added 's' the Django adds to the models name in the browser display
